  ...
  theme: {
    extend: {
      colors: {
        ...
        'off-white': '#FAFAFA',
        // Dark color palette for dark-themed pages (dark-50, dark-100, etc.)
        // Also used for text-dark-400, bg-dark-900, etc.
        'dark': {
          50: '#f9fafb',
          100: '#f3f4f6',
          200: '#e5e7eb',
          ...
          900: '#111827',
          950: '#030712',
          // Base dark color for text-dark class (used in light-themed pages)
          DEFAULT: '#1A1A1A',
        },
        primary: {
          50: "#f0f9ff",
